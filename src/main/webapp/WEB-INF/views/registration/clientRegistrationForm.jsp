                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="name" ng-model="name" name="name" type="text"
                               placeholder="Enter Your Name" class="form-control input-md" required="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="cpassword" name="cpassword" ng-model="cpassword" type="password"
                               placeholder="Rewrite you password" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="dateOfBirth" ng-model="dateOfBirth" name="dateOfBirth" type="text"
                               placeholder="Select Date" class="form-control input-md" required="">
                    </div>
                </div>
